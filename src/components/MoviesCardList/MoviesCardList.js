...
const MoviesCardList = () => {
  ...
  return (
    <>
      <SearchForm error={error} setCheckboxState={setCheckboxState} searchMovies={searchMovies} changeSearchRequest={changeSearchRequest} setRenderMore={setRenderMore}/>
      {preloader && <Preloader />}
